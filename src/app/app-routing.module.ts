...
const AppRoutes: Routes = [
    ...
    { path: 'profile', loadChildren: () => import('./profile/profile.module').then(m => m.ProfileModule), canActivate: [CanActivateGuard] },
    ...
    { path: 'login', loadChildren: () => import('./login/login.module').then(m => m.LoginModule), canActivate: [CanActivateLoginGuard] },
